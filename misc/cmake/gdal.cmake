...
elseif(UNIX)
  ...
  if(GDAL_CONFIG) 
    ...
    if(GDAL_VERSION_MAJOR LESS 2)
      if(GDAL_VERSION_MAJOR LESS 1 OR GDAL_VERSION_MINOR LESS 10)
        message (FATAL_ERROR "GDAL version is too old (${GDAL_VERSION}). Use 1.10 or higher.")
      endif()
    endif()
...
add_definitions("-I ${GDAL_INCLUDE_DIR}")
link_directories(${GDAL_LINK_DIRECTORIES})
