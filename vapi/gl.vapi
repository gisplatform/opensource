...
namespace GL {
	...
	// XXX SS_FIXED public static void glGenTextures (GL.GLsizei n, [CCode (array_length = false, array_null_terminated = true)] out unowned GL.GLuint[] textures);
	...
	public static void glReadPixels (GL.GLint x, GL.GLint y, GL.GLsizei width, GL.GLsizei height, GL.GLenum format, GL.GLenum type, [CCode (array_length = false, array_null_terminated = true)] GL.GLvoid[] pixels);
	// XXX SS_FIXED public static void glReadPixels (GL.GLint x, GL.GLint y, GL.GLsizei width, GL.GLsizei height, GL.GLenum format, GL.GLenum type, [CCode (array_length = false, array_null_terminated = true)] out unowned GL.GLvoid[] pixels);
