...
namespace Gdk {
	...
	{
		// XXX SS_FIXED public GLContext (Gdk.GLDrawable gldrawable, Gdk.GLContext share_list, bool direct, int render_type);
	...
	public class WindowGL {
		// XXX SS_FIXED public static unowned Gdk.GLWindow set_gl_capability (Gdk.Window window, Gdk.GLConfig glconfig, [CCode (array_length = false)] int[] attrib_list);
